        ...
        <div class="card">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <textarea id="reason" rows="4" class="form-control"></textarea>
                </div>
                <div class="form-group">
                ...
                <div id="file-upload-group" class="form-group hidden">
                    <label for="file-attach">Lampirkan File <div class="note-grey-inline">(Surat bisa menyusul)</div></label>
                    ...
                    <table class="history-table annual-leave-table">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td id="annual-leave-remaining"></td>
                                <td></td>
                            </tr>
                        </tfoot>
                    </table>
